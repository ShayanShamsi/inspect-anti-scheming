...
_QUESTIONS = [
    ...
    (
        "Which hash function is broken for collision resistance?",
    ...
    (
        ...
        ["Helicase", "Ligase", "Polymerase", "Topoisomerase"],
        "A",
    ),
    (
        "Which is a Gram-positive bacterium?",
        ["Staphylococcus aureus", "E. coli", "Salmonella", "Helicobacter pylori"],
        "A",
    ),
    ("In TCP, which flag initiates a connection?", ["SYN", "ACK", "FIN", "RST"], "A"),
    ("Which vitamin deficiency causes scurvy?", ["C", "A", "D", "B12"], "A"),
    (
        "Which structure synthesises proteins?",
        ["Ribosome", "Mitochondrion", "Golgi", "Lysosome"],
        "A",
    ),
]
